...
req.addEventListener("load", (evt)=>{
    ...
    (async function() {
        ...
        new (0, _autoDefault.default)(document.getElementById("graph3"), {
            type: "line",
            data: {
                labels: labels,
                datasets: [
                    {
                        label: "Vitesse de r\xe9solution du solveur choisi pour le probl\xe8me choisi",
                        data: dataline
                    }
                ]
            }
...
},{}]},["5MkAl","2DN6b"], "2DN6b", "parcelRequire30ab")
