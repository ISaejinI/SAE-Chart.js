...
req.addEventListener("load", (evt)=>{
    ...
    (async function() {
        ...
        if ((0, _autoDefault.default).getChart(document.getElementById("graph3")) != undefined) (0, _autoDefault.default).getChart(document.getElementById("graph3")).destroy();
        line = new (0, _autoDefault.default)(document.getElementById("graph3"), {
            type: "line",
            data: {
                labels: labels,
                datasets: [
